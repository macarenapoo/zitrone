...
define('DB_NAME', 'db6869_zitrone');

/** MySQL database username */
define('DB_USER', 'db6869');

/** MySQL database password */
define('DB_PASSWORD', '!lA#8Ug7rv');
...
define('WP_HOME','http://wwwold.zitrone.com.mx/wordpress');
define('WP_SITEURL','http://wwwold.zitrone.com.mx/wordpress');
