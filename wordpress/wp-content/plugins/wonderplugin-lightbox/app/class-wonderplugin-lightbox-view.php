...
class WonderPlugin_Lightbox_View {
	...
	function print_options() {
		...
		<tr valign="top">
			...
			<td><label><input name="defaultvideovolume" type="number" step="any" id="defaultvideovolume" value="<?php echo esc_html($lightbox_options['defaultvideovolume']); ?>" class="small-text" /> (0 - 1)</label></td>
		</tr>
		
		<tr valign="top">
			<th scope="row">Overlay color</th>
			<td><input name="overlaybgcolor" type="text" id="overlaybgcolor" value="<?php echo esc_html($lightbox_options['overlaybgcolor']); ?>" class="regular-text" /></td>
		</tr>
		
		<tr valign="top">
			<th scope="row">Overlay opacity</th>
			<td><input name="overlayopacity" type="text" id="overlayopacity" value="<?php echo esc_html($lightbox_options['overlayopacity']); ?>" class="small-text" /></td>
		</tr>
		
		<tr valign="top">
			<th scope="row">Background color</th>
			<td><input name="bgcolor" type="text" id="bgcolor" value="<?php echo esc_html($lightbox_options['bgcolor']); ?>" class="regular-text" /></td>
		</tr>
		
		<tr valign="top">
			<th scope="row">Border radius</th>
			<td><input name="borderradius" type="text" id="borderradius" value="<?php echo esc_html($lightbox_options['borderradius']); ?>" class="small-text" /></td>
		</tr>
		
		<tr valign="top">
			<th scope="row">Maximum text bar height</th>
			<td><input name="barheight" type="text" id="barheight" value="<?php echo esc_html($lightbox_options['barheight']); ?>" class="small-text" /></td>
		</tr>
		...
		<tr valign="top">
			...
			<td><input name="thumbwidth" type="text" id="thumbwidth" value="<?php echo esc_html($lightbox_options['thumbwidth']); ?>" class="small-text" /> by <input name="thumbheight" type="text" id="thumbheight" value="<?php echo esc_html($lightbox_options['thumbheight']); ?>" class="small-text" /></td>
		</tr>

		<tr valign="top">
			<th scope="row">Thumbnail top margin</th>
			<td><input name="thumbtopmargin" type="text" id="thumbtopmargin" value="<?php echo esc_html($lightbox_options['thumbtopmargin']); ?>" class="small-text" /></td>
		</tr>
		
		<tr valign="top">
			<th scope="row">Thumbnail bottom margin</th>
			<td><input name="thumbbottommargin" type="text" id="thumbbottommargin" value="<?php echo esc_html($lightbox_options['thumbbottommargin']); ?>" class="small-text" /></td>
		</tr>	
		
		<tr valign="top">
			<th>Advanced Options</th>
			<td><textarea name='advancedoptions' id='advancedoptions' value='' class='large-text' rows="5"><?php echo esc_html($lightbox_options['advancedoptions']); ?></textarea></td>
		</tr>	
        </table>
...
&lt;/div&gt;&lt;/div&gt;
		...
		<p>To make the content itself responsive, please also add the following CSS code to your webpage:</p>
		<div class="code">
<pre>
&lt;style type=&quot;text/css&quot;&gt;
.lightboxcontainer {
